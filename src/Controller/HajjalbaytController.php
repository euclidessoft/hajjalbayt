...
{
    public function index(Request $request, ObjectManager $manager, UserPasswordEncoderInterface $encoder, TokenGeneratorInterface $tokenGenerator, \Swift_Mailer $mail)
    {
        $agence = new Agence();
...
//          $mail->send($message);
     ...
     */
    public function inscription(Request $request, ObjectManager $manager, UserPasswordEncoderInterface $encoder, TokenGeneratorInterface $tokenGenerator, \Swift_Mailer $mail)
    {
        $agence = new Agence();
        $form = $this->createForm(AgenceType::class, $agence);
        $form->remove('adresse');
